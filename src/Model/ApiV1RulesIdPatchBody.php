...
class ApiV1RulesIdPatchBody extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var ApiV1RulesIdPatchBodyConditions|null
     */
    protected $conditions;
    /**
     * The actions for the rule.
     *
     * @var ApiV1RulesIdPatchBodyActions|null
     */
    protected $actions;
    /**
     ...
     * The conditions for the rule.
     *
     * @return ApiV1RulesIdPatchBodyConditions|null
     */
    public function getConditions() : ?ApiV1RulesIdPatchBodyConditions
    {
     ...
     * The conditions for the rule.
     *
     * @param ApiV1RulesIdPatchBodyConditions|null $conditions
     *
     * @return self
     */
    public function setConditions(?ApiV1RulesIdPatchBodyConditions $conditions) : self
    {
     ...
     * The actions for the rule.
     *
     * @return ApiV1RulesIdPatchBodyActions|null
     */
    public function getActions() : ?ApiV1RulesIdPatchBodyActions
    {
        return $this->actions;
    }
    /**
     * The actions for the rule.
     *
     * @param ApiV1RulesIdPatchBodyActions|null $actions
     *
     * @return self
     */
    public function setActions(?ApiV1RulesIdPatchBodyActions $actions) : self
    {
