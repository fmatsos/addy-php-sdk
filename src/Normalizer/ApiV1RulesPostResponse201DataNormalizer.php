...
class ApiV1RulesPostResponse201DataNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface, CacheableSupportsMethodInterface
{
    ...
    {
        return $type === 'Addy\\Api\\Model\\ApiV1RulesPostResponse201Data';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Addy\\Api\\Model\\ApiV1RulesPostResponse201Data';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Addy\Api\Model\ApiV1RulesPostResponse201Data();
        ...
        if (\array_key_exists('conditions', $data) && $data['conditions'] !== null) {
            ...
            foreach ($data['conditions'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Addy\\Api\\Model\\ApiV1RulesPostResponse201DataConditionsItem', 'json', $context);
            }
        ...
        if (\array_key_exists('actions', $data) && $data['actions'] !== null) {
            ...
            foreach ($data['actions'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Addy\\Api\\Model\\ApiV1RulesPostResponse201DataActionsItem', 'json', $context);
            }
    ...
    {
        return array('Addy\\Api\\Model\\ApiV1RulesPostResponse201Data' => true);
    }
