...
class ApiV1RulesPostBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface, CacheableSupportsMethodInterface
{
    ...
    {
        return $type === 'Addy\\Api\\Model\\ApiV1RulesPostBody';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Addy\\Api\\Model\\ApiV1RulesPostBody';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Addy\Api\Model\ApiV1RulesPostBody();
        ...
        if (\array_key_exists('conditions', $data) && $data['conditions'] !== null) {
            $object->setConditions($this->denormalizer->denormalize($data['conditions'], 'Addy\\Api\\Model\\ApiV1RulesPostBodyConditions', 'json', $context));
        ...
        if (\array_key_exists('actions', $data) && $data['actions'] !== null) {
            $object->setActions($this->denormalizer->denormalize($data['actions'], 'Addy\\Api\\Model\\ApiV1RulesPostBodyActions', 'json', $context));
            unset($data['actions']);
        }
    ...
    {
        return array('Addy\\Api\\Model\\ApiV1RulesPostBody' => true);
    }
