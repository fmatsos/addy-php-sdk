...
class ApiV1AliasRecipientsPostResponse200DataNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface, CacheableSupportsMethodInterface
{
    ...
    {
        return $type === 'Addy\\Api\\Model\\ApiV1AliasRecipientsPostResponse200Data';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Addy\\Api\\Model\\ApiV1AliasRecipientsPostResponse200Data';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Addy\Api\Model\ApiV1AliasRecipientsPostResponse200Data();
        ...
        if (\array_key_exists('recipients', $data) && $data['recipients'] !== null) {
            ...
            foreach ($data['recipients'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Addy\\Api\\Model\\ApiV1AliasRecipientsPostResponse200DataRecipientsItem', 'json', $context);
            }
    ...
    {
        return array('Addy\\Api\\Model\\ApiV1AliasRecipientsPostResponse200Data' => true);
    }
