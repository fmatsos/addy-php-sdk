...
class ApiV1RulesPostResponse201DataConditionsItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface, CacheableSupportsMethodInterface
{
    ...
    {
        return $type === 'Addy\\Api\\Model\\ApiV1RulesPostResponse201DataConditionsItem';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Addy\\Api\\Model\\ApiV1RulesPostResponse201DataConditionsItem';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Addy\Api\Model\ApiV1RulesPostResponse201DataConditionsItem();
    ...
    {
        return array('Addy\\Api\\Model\\ApiV1RulesPostResponse201DataConditionsItem' => true);
    }
