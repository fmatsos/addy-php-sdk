...
class ApiV1UsernamesIdDefaultRecipientPatchResponse200DataNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface, CacheableSupportsMethodInterface
{
    ...
    {
        return $type === 'Addy\\Api\\Model\\ApiV1UsernamesIdDefaultRecipientPatchResponse200Data';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Addy\\Api\\Model\\ApiV1UsernamesIdDefaultRecipientPatchResponse200Data';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Addy\Api\Model\ApiV1UsernamesIdDefaultRecipientPatchResponse200Data();
        ...
        if (\array_key_exists('default_recipient', $data) && $data['default_recipient'] !== null) {
            $object->setDefaultRecipient($this->denormalizer->denormalize($data['default_recipient'], 'Addy\\Api\\Model\\ApiV1UsernamesIdDefaultRecipientPatchResponse200DataDefaultRecipient', 'json', $context));
    ...
    {
        return array('Addy\\Api\\Model\\ApiV1UsernamesIdDefaultRecipientPatchResponse200Data' => true);
    }
