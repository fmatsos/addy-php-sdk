...
class DeactivateASpecificDomain extends \Addy\Api\Runtime\Client\BaseEndpoint implements \Addy\Api\Runtime\Client\Endpoint
{
    protected $id;
    /**
    ...
    {
        return str_replace(array('{id}'), array($this->id), '/api/v1/active-domains/{id}');
    }
