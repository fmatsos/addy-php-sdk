...
class GetASpecificRecipient extends \Addy\Api\Runtime\Client\BaseEndpoint implements \Addy\Api\Runtime\Client\Endpoint
{
    protected $id;
    /**
    ...
    {
        return str_replace(array('{id}'), array($this->id), '/api/v1/recipients/{id}');
    }
     ...
     *
     *
     * @return null|\Addy\Api\Model\ApiV1RecipientsIdGetResponse200
     */
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (is_null($contentType) === false && (200 === $status && mb_strpos($contentType, 'application/json') !== false)) {
            return $serializer->deserialize($body, 'Addy\\Api\\Model\\ApiV1RecipientsIdGetResponse200', 'json');
        }
    }
